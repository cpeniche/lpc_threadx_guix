...
BCKWRD_WINDOW_CONTROL_BLOCK bckwrd_window;
...
GX_STUDIO_DISPLAY_INFO sample_display_table[1] =
{
    {
    "display_1",
    "display_1_canvas",
...
GX_WINDOW_PROPERTIES bckwrd_window_properties =
{
    0                                        /* wallpaper pixelmap id          */
};
GX_PIXELMAP_BUTTON_PROPERTIES bckwrd_window_pixelmap_button_properties =
{
    GX_PIXELMAP_ID_USB_80_80,                /* normal pixelmap id             */
    GX_PIXELMAP_ID_USB_80_80_SEL,            /* selected pixelmap id           */
    GX_PIXELMAP_ID_USB_80_80_DIS             /* disabled pixelmap id           */
};

GX_CONST GX_STUDIO_WIDGET bckwrd_window_pixelmap_button_define =
{
    "pixelmap_button",
    ...
    {24, 18, 108, 97},                       /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(BCKWRD_WINDOW_CONTROL_BLOCK, bckwrd_window_pixelmap_button), /* control block */
    (void *) &bckwrd_window_pixelmap_button_properties /* extended properties  */
};

GX_CONST GX_STUDIO_WIDGET bckwrd_window_define =
{
    "bckwrd_window",
    ...
    GX_STATUS_ACCEPTS_FOCUS,                 /* status flags                   */
    sizeof(BCKWRD_WINDOW_CONTROL_BLOCK),     /* control block size             */
    ...
    GX_NULL,                                 /* next widget                    */
    &bckwrd_window_pixelmap_button_define,   /* child widget                   */
    0,                                       /* control block                  */
    (void *) &bckwrd_window_properties       /* extended properties            */
};
GX_CONST GX_STUDIO_WIDGET_ENTRY sample_widget_table[] =
{
    { &bckwrd_window_define, (GX_WIDGET *) &bckwrd_window },
    {GX_NULL, GX_NULL}
};
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = sample_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &sample_display_table[display];
